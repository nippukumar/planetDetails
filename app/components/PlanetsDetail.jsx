...
import { getPlanets } from '../actions/login.js';
...
class PlanetsDetail extends Component {
    ...
    componentWillReceiveProps(nextProps) {
        if (nextProps.userDetails.userData) {
            this.setState({
                userName: nextProps.userDetails.userData.results[0].name,
            ...
            <div className="col-md-12 col-sm-12 no-padding planet-component">
                <div className="input-group">
                    <div className="ais-search-box">
                        <input id="search-input" className="form-control ais-search-box--input" placeholder="Search for planet detail" onChange={(e) => this.handleChangeOnSearch(e)}></input>
                    </div>
                                    ...
                                    return (
                                        <div className="planets" key={index}
                                            ...
                                            <span className="planet-population">
                                                Planets Population: {data.population}
                                            </span>
                                        </div>
                                    )
                                })
...
export default connect(mapStateToProps)(PlanetsDetail);